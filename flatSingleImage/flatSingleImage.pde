...
fullScreen(); 
//Population
pic = loadImage("molly.jpg"); //Dimesions: width 800, height 600
//Note: Dimensions are found in the image file / Right Click / Properties / Details
//Find the larger dimenstion for aspect ratio
int picWidth = displayWidth; //Mine is 800, do not copy this!!!
int picHeight = displayHeight; //Mine is 600, do not copy this!!!
